"""
input_helpers.py — CLI prompts that loop until a valid value is given.

FIX vs. the original script: the original only checked that age /
weight / height were positive numbers. That allowed nonsense like a
height of "1" cm, which silently produced a BMI of 870000 in the
real log file this project shipped with. Each prompt below now also
enforces a sane real-world range.
"""
